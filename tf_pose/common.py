...
def get_sample_images(w, h):
    val_image = [
        read_imgfile('./data/img/p1.jpg', w, h),
        read_imgfile('./data/img/p2.jpg', w, h),
        read_imgfile('./data/img/p3.jpg', w, h),
        read_imgfile('./data/img/golf.jpg', w, h),
        read_imgfile('./data/img/hand1.jpg', w, h),
        read_imgfile('./data/img/hand2.jpg', w, h),
        read_imgfile('./data/img/apink1_crop.jpg', w, h),
        read_imgfile('./data/img/ski.jpg', w, h),
        read_imgfile('./data/img/apink2.jpg', w, h),
        read_imgfile('./data/img/apink3.jpg', w, h),
        read_imgfile('./data/img/handsup1.jpg', w, h),
        read_imgfile('./data/img/p3_dance.png', w, h),
    ]
    return val_image
